...
truncLogLiklihoodD <- function(par, H, k, sf, theta, minMu = 0.01) {
    .Call('_OUTRIDER_truncLogLiklihoodD', PACKAGE = 'OUTRIDER', par, H, k, sf, theta, minMu)
}

gradientD <- function(par, H, k, sf, theta, minMu = 0.01) {
    .Call('_OUTRIDER_gradientD', PACKAGE = 'OUTRIDER', par, H, k, sf, theta, minMu)
}

truncLogLiklihoodE <- function(e, D, k, b, x, sf, theta, minMu = 0.01) {
    .Call('_OUTRIDER_truncLogLiklihoodE', PACKAGE = 'OUTRIDER', e, D, k, b, x, sf, theta, minMu)
}

gradientE <- function(e, D, k, b, x, sf, theta, minMu = 0.01) {
