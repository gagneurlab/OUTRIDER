...
py_outrider_env <- BasiliskEnvironment("py_outrider_env", pkgname="OUTRIDER",
    packages=c("python=3.6.12", 
            "anndata==0.7.5", "statsmodels==0.11.1", "pandas==1.1.5", 
            "numpy==1.19.5", "scikit-learn==0.23.1"),
