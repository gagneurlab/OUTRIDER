...
// [[Rcpp::export(rng=false)]]
SEXP truncLogLiklihoodOutlier(arma::mat k, arma::mat x, arma::mat W, arma::vec b, 
  ...
  double m2= arma::accu((k.each_row() + theta) % arma::log(sexpy.each_row() + theta) % outlier);
  double Loss = m1+m2;
...
// [[Rcpp::export(rng=false)]]
SEXP gradLogLiklihoodOutlier(arma::mat k, arma::mat x, arma::mat W, arma::vec b, 
                      arma::vec s, arma::vec theta, arma::mat outlier){
